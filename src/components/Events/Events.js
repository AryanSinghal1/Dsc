  ...
  render() {
    ...
    return (
      <div className={styles.Events}>
        <Helmet>
          <title>GDSC | AKGEC | Events</title>
          <meta
            name="description"
            content="Developer Student Clubs AKGEC Events"
          />
          <meta property="og:title" content="GDSC AKGEC" />
          ...
          <meta name="twitter:title" content="GDSC AKGEC Events" />
          <meta
          ...
          <meta itemprop="name" content="GDSC AKGEC Events" />
          <meta
